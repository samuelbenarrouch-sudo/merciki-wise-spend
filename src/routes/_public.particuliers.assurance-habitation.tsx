...
const data = getAssuranceParticuliere("assurance-habitation")!;

export const Route = createFileRoute("/_public/particuliers/assurance-habitation")({
  head: () => {
    const url = absoluteUrl("/particuliers/assurance-habitation");
    return {
      meta: [
