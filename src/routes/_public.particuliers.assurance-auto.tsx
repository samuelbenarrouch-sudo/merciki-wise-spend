...
const data = getAssuranceParticuliere("assurance-auto")!;

export const Route = createFileRoute("/_public/particuliers/assurance-auto")({
  head: () => {
    const url = absoluteUrl("/particuliers/assurance-auto");
    return {
      meta: [
